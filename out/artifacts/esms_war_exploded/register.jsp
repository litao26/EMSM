...
<script type="text/javascript" src="js/jquery.js"></script>
    <script type="text/javascript">
        ...
        function changeCode() {
            $("#mmcode").attr("src","checkCode.do?r="+new Date().getTime());
        }
    </script>
    <script type="text/javascript">
        function register() {
           ...
           <form action="register.do" method="post">
           	<div class="user_form"> 
                ...
                <div class="uInfo">
                    ...
                    <input type="password"  class="text" id="pass1" name="password"/>
                </div> 
                <div class="uInfo">
                	<span class="label">确认密码：</span>
                    <input type="password" class="text" id ="pass2" name="re_password" onblur="register()" />
                    <span id ="sp2"></span>
                </div>
                <div class="uInfo">
                ...
                <div class="uInfo">
                    ...
                    <input type="text" id="code"  onblur="validCode()"/><img src="checkCode.do"  id="mmcode" onclick="changeCode()"/>    <font>看不清？</font><a href="javascript:" onclick="changeCode()">换一张</a>
                    <span id="sp1"></span>
                </div>
                <div class="uInfo">
