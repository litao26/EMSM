    ...
    <div id="login">
        ...
        <div class="login_form">
			...
			<form id="login_form" action="login.do" method="post">
             	<div class="form_info">
                	<div class="label">用户名：</div><input type="text"   class="text" name="login_name"/>
                </div>
             	<div class="form_info">
                	<div class="label">密码：</div><input type="password"  class="text" name="password"/>
                </div>
                <div class="form_info">
                	<div class="label">&nbsp;</div>
                ...
                <div class="form_info">
                	<div class="label">&nbsp;</div>
                	<button type="submit"  id ="lg_button"><a href="#"><img id="login_btn" src="images/login.jpeg" /></a></button>${msg}
                </div>
                <div class="cor_web">
                    使用合作网站账号登录京东：<br />
